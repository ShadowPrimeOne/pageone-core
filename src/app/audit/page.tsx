...
export default function AuditSearchRootPage() {
  ...
  return (
    <main className="p-6">
      ...
      <p className="mt-2 text-sm text-gray-600">Start an audit by searching Google Places AU. You can open this from Pipeline leads or directly here.</p>
